        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearlyQuota = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notices_Employees_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NoticeReadId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NoticeId = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoticeReads", x => x.NoticeReadId);
                    table.ForeignKey(
                        name: "FK_NoticeReads_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NoticeTargets_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NoticeTargets_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoticeReads_EmployeeId",
                table: "NoticeReads",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_NoticeReads_NoticeId_EmployeeId",
                table: "NoticeReads",
                columns: new[] { "NoticeId", "EmployeeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Notices_CreatedByEmployeeId",
                table: "Notices",
                column: "CreatedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_NoticeTargets_DepartmentId",
                table: "NoticeTargets",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_NoticeTargets_EmployeeId",
                table: "NoticeTargets",
                column: "EmployeeId");
